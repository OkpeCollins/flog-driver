...
import { getCurrentWeekBalance } from '../../actions/earning.action';

function CurrentWeek({navigation}) {
  const dispatch = useDispatch();
  const user = useSelector(state => state.login.user);
  const balanceCurrentWeek = useSelector(state => state.earning.balanceCurrentWeek);
  ...
  React.useEffect(() => {
    ...
    dispatch(getCurrentWeekBalance(data));
  }, [])
    ...
    <View style={styles.main}>
      ...
      <View style={styles.balanceContainer}>
        <View style={styles.balContainer}>
          ...
          <Text style={styles.balMoney}>-{naira + balanceCurrentWeek.startingBalance}</Text>
        </View>
