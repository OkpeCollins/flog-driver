...
import { getPreviousWeekBalance, getPreviousWeekNet } from '../../actions/earning.action';

function LastWeek({navigation}) {
  const dispatch = useDispatch();
  const user = useSelector(state => state.login.user);
  const balancePreviousWeek = useSelector(state => state.earning.balancePreviousWeek);
  ...
  React.useEffect(() => {
    ...
    dispatch(getPreviousWeekBalance(data));
  }, [])
    ...
    <View style={styles.main}>
      ...
      <View style={styles.balanceContainer}>
        <View style={styles.balContainer}>
          ...
          <Text style={styles.balMoney}>-{naira + balancePreviousWeek.startingBalance}</Text>
        </View>
